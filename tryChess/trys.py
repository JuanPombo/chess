...
sizePiece = (80,80)
#BLACK PIECES
kingB = pygame.transform.scale(pygame.image.load("tryChess\piezas\KingB.png"),sizePiece)
queenB = pygame.transform.scale(pygame.image.load("tryChess\piezas\QueenB.png"),sizePiece)
rookB0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\RookB.png"),sizePiece)
rookB1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\RookB.png"),sizePiece)
knightB0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\KnightB.png"),sizePiece)
knightB1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\KnightB.png"),sizePiece)
bishopB0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\BishopB.png"),sizePiece)
bishopB1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\BishopB.png"),sizePiece)
pawnB0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB2 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB3 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB4 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB5 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB6 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
pawnB7 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnB.png"),sizePiece)
#WHITE PIECES
kingW = pygame.transform.scale(pygame.image.load("tryChess\piezas\KingW.png"),sizePiece)
queenW = pygame.transform.scale(pygame.image.load("tryChess\piezas\QueenW.png"),sizePiece)
rookW0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\RookW.png"),sizePiece)
rookW1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\RookW.png"),sizePiece)
knightW0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\KnightW.png"),sizePiece)
knightW1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\KnightW.png"),sizePiece)
bishopW0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\BishopW.png"),sizePiece)
bishopW1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\BishopW.png"),sizePiece)
pawnW0 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW1 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW2 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW3 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW4 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW5 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW6 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
pawnW7 = pygame.transform.scale(pygame.image.load("tryChess\piezas\PawnW.png"),sizePiece)
        ...
        for i in range(1):
            for j in range(16):
                if ((matrix[i][j][0].x < mousePos.x < (matrix[i][j][0].x + 80)) and (matrix[i][j][0].y < mousePos.y < (matrix[i][j][0].y + 80))): #Check if the mouse is click-on any piece
                    matrix[i][j][1] = True
    else:#Turn in check the clikc on the White pieces for avoid error 
        for i in range(1,2):
            for j in range(16):
                if ((matrix[i][j][0].x < mousePos.x < (matrix[i][j][0].x + 80)) and (matrix[i][j][0].y < mousePos.y < (matrix[i][j][0].y + 80))): #Check if the mouse is click-on any piece
                    matrix[i][j][1] = True

    if matrix[2] != True : #The turn of the black pieces
        #BLACK PIECES
        ...
        if matrix[0][1][1] == True:#KNIGHT BLACK 0
            ...
            for i in range(1,9):
                if not (mousePos.x < 0 and mousePos.y < 0):
                    if((matrix[0][1][0].x - i*80< mousePos.x < matrix[0][1][0].x-(i-1)*80) and (matrix[0][1][0].y - i*80 < mousePos.y < matrix[0][1][0].y-(i-1)*80)):#Upper left diagonally
                        matrix[0][1][0] = pygame.Vector2(matrix[0][1][0].x - (i*80),matrix[0][1][0].y - (i*80))
                        matrix[0][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][1][0].x + i*80< mousePos.x < matrix[0][1][0].x+(i+1)*80) and (matrix[0][1][0].y - i*80 < mousePos.y < matrix[0][1][0].y-(i-1)*80)):#Upper right diagonally
                        matrix[0][1][0] = pygame.Vector2(matrix[0][1][0].x + (i*80),matrix[0][1][0].y - (i*80))
                        matrix[0][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][1][0].x + i*80< mousePos.x < matrix[0][1][0].x+(i+1)*80) and (matrix[0][1][0].y +i*80 < mousePos.y < matrix[0][1][0].y+(i+1)*80)):#Lower  right diagonally
                        matrix[0][1][0] = pygame.Vector2(matrix[0][1][0].x + (i*80),matrix[0][1][0].y + (i*80))
                        matrix[0][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][1][0].x - i*80< mousePos.x < matrix[0][1][0].x-(i-1)*80) and (matrix[0][1][0].y +i*80 < mousePos.y < matrix[0][1][0].y+(i+1)*80)):#Lower left diagonaly
                        matrix[0][1][0] = pygame.Vector2(matrix[0][1][0].x - (i*80),matrix[0][1][0].y + (i*80))
                        matrix[0][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    if not (matrix[0][1][0].x<mousePos.x<matrix[0][1][0].x+80 and matrix[0][1][0].y<mousePos.y<matrix[0][1][0].y+80):#Check if the clik was in outside of his zone
                        matrix[0][1][1] = False
        if matrix[0][6][1] == True:#KNIGHT BLACK 1
            ...
            for i in range(1,9):
                if not (mousePos.x < 0 and mousePos.y < 0):
                    if((matrix[0][6][0].x - i*80< mousePos.x < matrix[0][6][0].x-(i-1)*80) and (matrix[0][6][0].y - i*80 < mousePos.y < matrix[0][6][0].y-(i-1)*80)):#Upper left diagonally
                        matrix[0][6][0] = pygame.Vector2(matrix[0][6][0].x - (i*80),matrix[0][6][0].y - (i*80))
                        matrix[0][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][6][0].x + i*80< mousePos.x < matrix[0][6][0].x+(i+1)*80) and (matrix[0][6][0].y - i*80 < mousePos.y < matrix[0][6][0].y-(i-1)*80)):#Upper right diagonally
                        matrix[0][6][0] = pygame.Vector2(matrix[0][6][0].x + (i*80),matrix[0][6][0].y - (i*80))
                        matrix[0][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][6][0].x + i*80< mousePos.x < matrix[0][6][0].x+(i+1)*80) and (matrix[0][6][0].y +i*80 < mousePos.y < matrix[0][6][0].y+(i+1)*80)):#Lower  right diagonally
                        matrix[0][6][0] = pygame.Vector2(matrix[0][6][0].x + (i*80),matrix[0][6][0].y + (i*80))
                        matrix[0][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    elif((matrix[0][6][0].x - i*80< mousePos.x < matrix[0][6][0].x-(i-1)*80) and (matrix[0][6][0].y +i*80 < mousePos.y < matrix[0][6][0].y+(i+1)*80)):#Lower left diagonaly
                        matrix[0][6][0] = pygame.Vector2(matrix[0][6][0].x - (i*80),matrix[0][6][0].y + (i*80))
                        matrix[0][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = True
                    if not (matrix[0][6][0].x<mousePos.x<matrix[0][6][0].x+80 and matrix[0][6][0].y<mousePos.y<matrix[0][6][0].y+80):#Check if the clik was in outside of his zone
                        matrix[0][6][1] = False
            ...
            for i in range(1,9):
                if not (mousePos.x < 0 and mousePos.y < 0):
                    if((matrix[0][2][0].x - i*80< mousePos.x < matrix[0][2][0].x-(i-1)*80) and (matrix[0][2][0].y - i*80 < mousePos.y < matrix[0][2][0].y-(i-1)*80)):#Upper left diagonally
                        ...
                        matrix[0][2][0] = pygame.Vector2(matrix[0][2][0].x - (i*80),matrix[0][2][0].y + (i*80))
                        for i in range(16):#Check if the piece has eaten other piece
                            if (matrix[0][2][0] == matrix[1][i][0]):
                                matrix[1][i][0] = pygame.Vector2(640,640)
                                mousePos = pygame.Vector2(-1,-1)
                            matrix[0][2][1] = False
                            matrix[2] = True
        ...
        if matrix[0][3][1] == True:#QUEEN BLACK
            if ((matrix[0][3][0].y<mousePos.y<matrix[0][3][0].y + 80) or (matrix[0][3][0].x<mousePos.x<matrix[0][3][0].x + 80)):#Range of queen    
        ...
        if matrix[1][1][1] == True:#KNIGHT WHITE 0
            ...
            for i in range(1,9):
                if not (mousePos.x < 0 and mousePos.y < 0):
                    if((matrix[1][1][0].x - i*80< mousePos.x < matrix[1][1][0].x-(i-1)*80) and (matrix[1][1][0].y - i*80 < mousePos.y < matrix[1][1][0].y-(i-1)*80)):#Upper left diagonally
                        matrix[1][1][0] = pygame.Vector2(matrix[1][1][0].x - (i*80),matrix[1][1][0].y - (i*80))
                        matrix[1][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][1][0].x + i*80< mousePos.x < matrix[1][1][0].x+(i+1)*80) and (matrix[1][1][0].y - i*80 < mousePos.y < matrix[1][1][0].y-(i-1)*80)):#Upper right diagonally
                        matrix[1][1][0] = pygame.Vector2(matrix[1][1][0].x + (i*80),matrix[1][1][0].y - (i*80))
                        matrix[1][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][1][0].x + i*80< mousePos.x < matrix[1][1][0].x+(i+1)*80) and (matrix[1][1][0].y +i*80 < mousePos.y < matrix[1][1][0].y+(i+1)*80)):#Lower  right diagonally
                        matrix[1][1][0] = pygame.Vector2(matrix[1][1][0].x + (i*80),matrix[1][1][0].y + (i*80))
                        matrix[1][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][1][0].x - i*80< mousePos.x < matrix[1][1][0].x-(i-1)*80) and (matrix[1][1][0].y +i*80 < mousePos.y < matrix[1][1][0].y+(i+1)*80)):#Lower left diagonaly
                        matrix[1][1][0] = pygame.Vector2(matrix[1][1][0].x - (i*80),matrix[1][1][0].y + (i*80))
                        matrix[1][1][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    if not (matrix[1][1][0].x<mousePos.x<matrix[1][1][0].x+80 and matrix[1][1][0].y<mousePos.y<matrix[1][1][0].y+80):#Check if the clik was in outside of his zone
                        matrix[1][1][1] = False
        if matrix[1][6][1] == True:#KNIGHT WHITE 1
            ...
            for i in range(1,9):
                if not (mousePos.x < 0 and mousePos.y < 0):
                    if((matrix[1][6][0].x - i*80< mousePos.x < matrix[1][6][0].x-(i-1)*80) and (matrix[1][6][0].y - i*80 < mousePos.y < matrix[1][6][0].y-(i-1)*80)):#Upper left diagonally
                        matrix[1][6][0] = pygame.Vector2(matrix[1][6][0].x - (i*80),matrix[1][6][0].y - (i*80))
                        matrix[1][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][6][0].x + i*80< mousePos.x < matrix[1][6][0].x+(i+1)*80) and (matrix[1][6][0].y - i*80 < mousePos.y < matrix[1][6][0].y-(i-1)*80)):#Upper right diagonally
                        matrix[1][6][0] = pygame.Vector2(matrix[1][6][0].x + (i*80),matrix[1][6][0].y - (i*80))
                        matrix[1][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][6][0].x + i*80< mousePos.x < matrix[1][6][0].x+(i+1)*80) and (matrix[1][6][0].y +i*80 < mousePos.y < matrix[1][6][0].y+(i+1)*80)):#Lower  right diagonally
                        matrix[1][6][0] = pygame.Vector2(matrix[1][6][0].x + (i*80),matrix[1][6][0].y + (i*80))
                        matrix[1][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    elif((matrix[1][6][0].x - i*80< mousePos.x < matrix[1][6][0].x-(i-1)*80) and (matrix[1][6][0].y +i*80 < mousePos.y < matrix[1][6][0].y+(i+1)*80)):#Lower left diagonaly
                        matrix[1][6][0] = pygame.Vector2(matrix[1][6][0].x - (i*80),matrix[1][6][0].y + (i*80))
                        matrix[1][6][1] = False
                        mousePos = pygame.Vector2(-1,-1)
                        matrix[2] = False
                    if not (matrix[1][6][0].x<mousePos.x<matrix[1][6][0].x+80 and matrix[1][6][0].y<mousePos.y<matrix[1][6][0].y+80):#Check if the clik was in outside of his zone
                        matrix[1][6][1] = False
        ...
        if matrix[1][3][1] == True:#QUEEN WHITE
            if ((matrix[1][3][0].y<mousePos.y<matrix[1][3][0].y + 80) or (matrix[1][3][0].x<mousePos.x<matrix[1][3][0].x + 80)):#Range of queen    
        ...
        for i in range(8,16): #PEON'S WHITE 0-7
            if (matrix[1][i][1] == True):
                if matrix[1][i][2] == True:
                    DISPLAYSURF.blit(transparentSurface, (matrix[1][i][0].x,matrix[1][i][0].y-80))
                    DISPLAYSURF.blit(transparentSurface, (matrix[1][i][0].x,matrix[1][i][0].y-160))
                    if (matrix[1][i][0].x<mousePos.x<matrix[1][i][0].x+80 and matrix[1][i][0].y-160<mousePos.y<matrix[1][i][0].y):
                        if (matrix[1][i][0].y - mousePos.y < 80):  #verificar
                ...
                if (matrix[1][i][0].x<mousePos.x<matrix[1][i][0].x+80 and matrix[1][i][0].y-80<mousePos.y<matrix[1][i][0].y):
                    ...
                    matrix[2] = False
                for j in range(16):#Print the blue hints when the pawn can capture
                    if((matrix[1][i][0].x - 80, matrix[1][i][0].y - 80) == (matrix[0][j][0].x , matrix[0][j][0].y )):
                        DISPLAYSURF.blit(transparentSurface, (matrix[1][i][0].x-80,matrix[1][i][0].y-80))
                    elif((matrix[1][i][0].x + 80, matrix[1][i][0].y - 80) == (matrix[0][j][0].x , matrix[0][j][0].y )):
                        DISPLAYSURF.blit(transparentSurface, (matrix[1][i][0].x+80,matrix[1][i][0].y-80))
                if (matrix[1][i][0].x-80<mousePos.x<matrix[1][i][0].x and matrix[1][i][0].y-80<mousePos.y<matrix[1][i][0].y):#Capture to the left
                     for j in range(16):
